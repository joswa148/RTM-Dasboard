...
<div class="la">
      ...
      <div class="row ">
        ...
        <div class="col-lg-6" id="leftCard">
          <!-- <div class="card-custom position-relative ">
            ...
            <p class="price fs-4">
              <span class="old-price"> <img src="assets/images/Dlogo.webp" alt="" style="width: 5%; ">1000</span>
        ...
        <div class="col-lg-6">
          ...
          <div class="card-custom mt-5 d-none d-lg-block mjs" onclick="loadCard('business2')">
            <h4>Trademark Registration Requirements in the India</h4> <span class="dece">(Business, Foreign Company,
              Individual)</span>
  ...
  <section class="whose ">
    ...
    <div class="container  ">
      ...
      <!-- Steps Grid -->
      <div class="d-flex gridrow align-items-center justify-content-between p-3">
        <div>
          <div class="step-box ">
    ...
    const cardContent = {
      ...
      business1: `<div class="card-custom position-relative ">
          ...
          <ul class="checklist" style="position: relative;z-index: 3000;">
              ...
              <li>Filing of trademark application</li>
              <li>Drafting of Trademark Application form</li>
              <li>Advice on trademark class & classification</li>1
              <li>Name Search and Approval</li>
              <li>Regular updates until registration</li>
                <li>Excludes the reply <br>to Trademark Objections</li>
            </ul>
