...
<div class="container security  py-5">
  <div class="row  g-4">
    ...
    <div class="col-md-4">
      <div class="info-card">
        <div class="info-icon">
          <img src="assets/images/s5.png" alt="icon">
...
<div class="ratingbox mb-4 mx-lg-5  mx-2">
    ...
    <div class="review-header">
      <div class="left-panel ">
        ...
        <p>
          powered by
          <img class="google-logo" src="assets/images/Google_2015.png" alt="Google" />
        </p>
        <button class="review-button">
          Review us on
          <img src="assets/images/g-logo.png" alt="G" style="height: 30px;" />
        </button>
      </div>
    ...
    <div class="review-header">
      <div class="left-panel">
        ...
        <div class="rating"><span class="green-star"><img src="assets/images/green-star.webp" width="55%" alt=""></span></div>
         ...
         <div class="trustimg"><img src="assets/images/truststart.png" alt="" width="50%"></div>
         <button class="review-button">
          Review us on
          <img src="assets/images/starsingle.png" alt="G" style="height: 30px;" />
        </button>
      </div>
        <div class="redbotter"></div>
      <div class="carousel-wrapper" aria-label="Client testimonials carousel">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6">
        <div class="advantage-box ">
          ...
          <div class="advantage-number"><img src="{{ asset('assets/images/w-1.webp') }}" alt=""></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="advantage-box2 ">
          ...
          <div class="advantage-number2"><img src="{{ asset('assets/images/w-2.webp') }}" alt=""></div>
           <p class="mt-2">
      ...
      <div class="col-md-6">
        <div class="advantage-box ">
         ...
         <div class="d-flex">
          ...
          <div class="advantage-number"><img src="{{ asset('assets/images/w-3.webp') }}" alt=""></div>
         </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="advantage-box2 ">
          ...
          <div class="d-flex">
             <div class="advantage-number2"><img src="{{ asset('assets/images/w-4.webp') }}" alt=""></div>
            <p class="mt-2">
