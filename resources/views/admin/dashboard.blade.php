...
@section('content')
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="stat-card">
                <div class="stat-card__icon" style="background:#fff7ed;color:#ea580c;"><i class="bi bi-eye-slash-fill"></i>
                </div>
                <div>
            ...
            <div class="rtm-card">
                ...
                <div class="rtm-card__body p-0">
                    @if($recentLogos->isEmpty())
                        <p style="padding:24px;color:#9ca3af;font-size:14px;">No logos yet. <a
                                href="{{ route('admin.logos.create') }}" style="color:#E51E25;">Add your first logo →</a></p>
                    @else
                        <table class="rtm-table">
                            ...
                            <tbody>
                                @foreach($recentLogos as $logo)
                                    <tr>
                                        <td>
                                            <img src="{{ $logo->image_url }}" alt="{{ $logo->alt_text }}" class="logo-thumb">
                                        </td>
                                        <td>{{ $logo->alt_text ?: '—' }}</td>
                                        <td>{{ $logo->order }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.logos.edit', $logo) }}" style="color:#6b7280;font-size:16px;"
                                                title="Edit">
        ...
        <div class="col-lg-5">
            <div class="rtm-card h-100">
                ...
                <div class="rtm-card__body d-flex flex-column gap-3">
                    ...
                    <a href="https://right-trademark.com/" target="_blank" class="btn-rtm-outline"
                        style="justify-content:center;padding:13px;border-color:#e5e7eb;color:#6b7280;">
