                    ...
                    <form action="{{ route('admin.logos.update', $logo) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" id="image" name="image"
                                class="rtm-form-control {{ $errors->has('image') ? 'is-invalid' : '' }}" accept="image/*">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="alt_text" name="alt_text"
                                ...
                                value="{{ old('alt_text', $logo->alt_text) }}" placeholder="e.g. Acme Corp logo"
                                maxlength="255">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="order" name="order"
                                ...
                                value="{{ old('order', $logo->order) }}" min="0" style="max-width:140px;">
                            <div class="rtm-form-text">Lower numbers appear first. Collisions are handled automatically.
                            </div>
                            @error('order')
                                <div class="rtm-invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4"
                            ...
                            <label class="rtm-check">
                                <input type="checkbox" name="is_active" id="is_active" {{ $logo->is_active ? 'checked' : '' }}>
                                <div>
                                    <div style="font-size:14px;font-weight:600;color:#111827;">Active — Visible on homepage
                                    </div>
