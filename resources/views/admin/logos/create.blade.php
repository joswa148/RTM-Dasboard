                ...
                <div class="rtm-card__body">
                    ...
                    <form action="{{ route('admin.logos.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-4">
                            ...
                            {{-- Drop zone --}}
                            <div class="logo-preview-box" id="dropZone" style="cursor:pointer;transition:border-color .2s;"
                            ...
                            <input type="file" id="image" name="image" accept="image/jpeg,image/png,image/webp,image/gif"
                                required style="display:none;" class="{{ $errors->has('image') ? 'is-invalid' : '' }}">
                            @error('image')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="alt_text" name="alt_text"
                                ...
                                value="{{ old('alt_text') }}" placeholder="e.g. Acme Corp logo" maxlength="255">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="order" name="order"
                                ...
                                value="{{ old('order') }}" min="0" style="max-width:140px;">
                            <div class="rtm-form-text">Leave blank to auto-assign next number. Lower numbers appear first.
                            </div>
                            @error('order')
                                <div class="rtm-invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:14px;">
                        <li style="display:flex;gap:10px;font-size:13px;color:#374151;">
                            <i class="bi bi-check-circle-fill"
                                style="color:#22c55e;font-size:16px;margin-top:1px;flex-shrink:0;"></i>
                        ...
                        <li style="display:flex;gap:10px;font-size:13px;color:#374151;">
                            <i class="bi bi-info-circle-fill"
                                style="color:#E51E25;font-size:16px;margin-top:1px;flex-shrink:0;"></i>
