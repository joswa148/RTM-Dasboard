        ...
        <div class="row align-items-center"> 
          ...
          <div class="col-md-7">
            ...
            <h1 class="fw-bold mb-2">
              Trademark <br>
             Registration  <span class="text-danger"> UAE</span>
            </h1>
            ...
            <h2 class="price fw-bold mb-4"><b style="color:#000;     font-weight: 700;"> Starts </b> <b class="at"> @ </b> <img src="public/assets/images/Dlogo.webp" alt="" style="width: 6%;position: relative;
    bottom: 4px;">7499 <span class="wkq" style="    color: #000;
    font-size: 18px;
    text-decoration: none;
    position: relative;
    top: -4px;">  (All inclusive) </span></h2>
      ...
      <div class="row ">
        ...
        <div class="col-lg-6" id="leftCard">
         <div class="card-custom position-relative ">
            <h4>Trademark Registration</h4>(Business, Foreign Company, Individual)</h4>
            <p class="price fs-4">
        ...
        <div class="col-lg-6" id="leftCard">
          <div class="card-custom d-none d-lg-block ">
            <h4>UAE Trademark Registration Requirements</h4> (Business, Foreign Company, Individual) </h4>
              <ul class="checklist" style="position: relative;z-index: 3000;">
...
onclick="openWhatsApp()" href="#" class="btn btn-whatsapp">
  ...
  <!-- advantage of trade mark start -->
    <div class="container mb-2">
        <div class="ssea">
    <h2 class="text-center fw-bold ">Advantages of</h2>
    <h1 class="text-center fw-bold text-danger mb-3">Trademark Registration</h1>
    </div>
    <div class="row g-4">
      <!-- Card 1 -->
      <div class="col-md-6">
  ...
  <section class="whose mt-4 mt-lg-0 dasasaSAda">
    ...
    <div class="container  ">
      ...
      <div class="section-title">
        <h2>We Help Our Clients to Secure <br> Their <span>Intellectual Property</span></h2>
