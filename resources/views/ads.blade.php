...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-6">
      ...
      <p style="margin-bottom:0px"><i class="bi bi-check-circle-fill me-2" style="color: #FA360A;"></i>Support marketing and growth strategies</p>
    </div>
  </div>
</div>
</section>
...
<div class="accordion pt-0 px-lg-5 px-4" id="accordionFlushExample">
  <p style="font-weight: 700; font-size: 35px;" class="text-center ouraccount">Ads & Campaign Design Services</p>
