...
<link rel="preload"
      href="{{ asset('public/assets/css/bootstrap.min.css') }}?v={{ $rtmVersion }}"
      as="style"
      onload="this.onload=null;this.rel='stylesheet'">

<link rel="preload"
      href="{{ asset('public/assets/css/style.css') }}?v={{ $rtmVersion }}"
      as="style"
      onload="this.onload=null;this.rel='stylesheet'">
...
<!-- ✅ Hero Image preload -->
<link rel="preload" as="image" href="{{ asset('public/assets/images/Frame-bg.webp') }}">
    ...
    <div class="tm-container">
      <div class="tm-row">
        <div class="tm-logo col-lg-2">
          ...
          <img src="{{ asset('public/assets/images/RTMlogo.png') }}" alt="Logo">
                    <!--<img src="https://majlisdates.com/rtmindia/public/assets/imagesuk/RTMUKlogo.webp" alt="" style="height:60px;">-->
          </a>
        </div>
        ...
        <a href="#" onclick="openWhatsApp()" class="btn btn-whatsapp  head-top-butto">
          <img src="public/assets/images/icon1.svg" alt=""> WhatsApp 
        </a>
        </div>
  ...
  <div class="container-fluid h-100">
    <div class="d-flex align-items-center justify-content-between h-100 px-2">
      ...
      <a href="#" class="d-flex align-items-center">
          <!--<img src="https://majlisdates.com/rtmindia/public/assets/imagesuk/RTMUKlogo.webp" alt="" style="height:60px;">-->
        <img src="{{ asset('public/assets/images/RTMlogo.png') }}" alt="Logo" style="height:50px;">
      </a>
  ...
  // 🔁 Change your number & message here
    ...
    function openWhatsApp() {
      ...
      imgs.forEach(img => {
        ...
        if (src) {
          // replace .png / .jpg / .jpeg / .svg with .webp
          const newSrc = src.replace(/\.(png|jpe?g|svg)$/i, ".webp");
