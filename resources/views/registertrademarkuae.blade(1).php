...
smartlook('init', '7065b670aec8a5f74b51ea1967a8fc3558769d81', { region: 'eu' });
</script>

  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Trademark Registration Online | Secure Your Brand with Right Trademark</title>
  <link rel="canonical" href="https://right-trademark.com/">
  
 <meta name="description" content="Register your trademark online with Right Trademark. Fast, reliable, and expert trademark filing services covering 100+ countries. Protect your brand today!">
    <?php /* <link rel="stylesheet" href="{{ asset('public/assets/css/style.css') }}"> */ ?>
  
    @php
        $rtmVersion = time();
    @endphp
    <link rel="stylesheet" href="{{ asset('public/assets/css/style.css') }}?v={{ $rtmVersion }}">
...
<link rel="icon" href="{{ asset('public/assets/images/favicon.webp') }}">
<!-- Bootstrap CSS -->
    ...
    <div class="tm-container">
      <div class="tm-row">
        <div class="tm-logo col-lg-2">
          ...
          <img src="{{ asset('public/assets/images/RTMlogo.webp') }}" alt="Logo">
          </a>
        </div>
                  ...
                  <ul class="tm-tabs">
                    ...
                    <li>
                      <a href="#" class="active">
                        ...
                        <img src="{{ asset('public/assets/images/we1.png') }}" alt=""> Trademark <span></span>
                      </a>
                      ...
                      <div class="row subbse">
                        ...
                        <div class="col-lg-4 d-block">
                          <h2>Post Filing Services</h2>
                           <ul>
                            <li> <a href="trademark-renewal"> Tradmark Renewal</a></li>
                    ...
                    <li>
                      <a href="#"><img src="{{ asset('public/assets/images/we2.png') }}" alt="#"> Business Setup </a>
                      <div class="tm-tab-content" hidden>
                         <div class="row subbse">
                               <div class="col-lg-4 d-block">
                    ...
                    <li>
                      <a href="#"> <img src="{{ asset('public/assets/images/we3.png') }}" alt=""> Technology</a>
                      <div class="tm-tab-content" hidden>
                          <div class="row subbse">
                               <div class="col-lg-4 d-block">
                    ...
                    <li>
                      <a href="#"><img src="{{ asset('public/assets/images/we4.png') }}" alt="#"> Branding </a>
                      <div class="tm-tab-content" hidden>
                         <div class="row subbse">
                               <div class="col-lg-4 d-block">
        ...
        <a href="#" onclick="openWhatsApp()" class="btn btn-whatsapp  head-top-butto">
          <img src="public/assets/images/icon1.webp" alt=""> WhatsApp Now
        </a>
        </div>
  ...
  <div class="container-fluid h-100">
    <div class="d-flex align-items-center justify-content-between h-100 px-2">
      ...
      <a href="#" class="d-flex align-items-center">
        <img src="{{ asset('public/assets/images/RTMlogo.webp') }}" alt="Logo" style="height:50px;">
      </a>
...
onclick="openWhatsApp()" class="btn btn-light boxsas rounded-circle p-2 d-flex align-items-center justify-content-center">
        ...
        <!-- Phone -->
        <a href="tel:+910000000000" class="btn btn-light boxsas rounded-circle p-2 d-flex align-items-center justify-content-center">
          <i class="bi bi-telephone fs-5" ></i>
        </a>

        <!-- Login -->
        <a href="#login" class="btn btn-primary fw-semibold px-3 py-1">Login</a>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
  ...
  <div class="offcanvas-body">
    ...
    <a href="about" class="d-block py-2 text-decoration-none">About</a>
    ...
    <section class="py-4 hero">
      <div class="container">
        <div class="row align-items-center"> 
          <!-- Left Content -->
          <div class="col-md-7">
              <p class="ksesee msewwe">UAE’s First-Ever 1-Day Express Application Approval</p>
            <h1 class="fw-bold mb-2">
              Trademark <br>
             Registration  <span class="text-danger"></span>
            </h1>
            
            <p class="fs-5 fw-semibold mb-3" style="    font-size: 16px !important;">Protect your Brand Name & Logo</p>
                        <!--<p class="fs-5 fw-semibold mb-3" style="    font-size: 16px !important;">UAE’s First-Ever 1-Day Express Application Approval - Fastest of all</p>-->
            <p class="price fw-bold mb-4"><b style="color:#000;     font-weight: 700;"> Starts </b> <b class="at"> @ </b> <img src="public/assets/images/Dlogo.webp" alt="" style="width: 6%;position: relative;
    bottom: 4px;">7499 <span class="wkq" style="    color: #000;
    font-size: 18px;
    text-decoration: none;
    position: relative;
    top: -4px;">  (All inclusive) </span></p>
            <a href="#"onclick="openWhatsApp()" class="btn btn-whatsapp">
              <img src="public/assets/images/icon1.webp" alt=""> WhatsApp Now
            </a>
          </div>
          ...
          <div class="col-md-5 text-center">
            <img src="public/assets/images/hero1.png" alt="Woman" class="img-fluid m-done" style="max-height: 400px;">
          </div>
        </div>
      </div>
      ...
      <div class="brandcontainer ">
        <p class="fs-3 text-center">Trusted by Over <b class="Trusted"> 5000+ </b> Brands Globally</p>
        <div class="d-flex gap-4 align-items-center justify-content-center">
          <div class="scroll-container">
              <div class="scroll-wrapper" id="scroll-wrapper">
                <img src="public/assets/images/logo-1.png" alt="Logo 1">
                <img src="public/assets/images/logo-2.png" alt="Logo 2">
                <img src="public/assets/images/logo-3.png" alt="Logo 3">
                <img src="public/assets/images/logo-4.png" alt="Logo 4">
                <img src="public/assets/images/logo-5.png" alt="Logo 5">
                <img src="public/assets/images/logo-6.png" alt="Logo 6">

              </div>
            </div>

          <!--<div class="img-border"></div>-->
          <!--<img src="public/assets/images/greview.png" class="we" width="180px" alt="">-->
          <!--<img src="public/assets/images/rating.png" class="we" width="180px" alt="">-->
        </div>
      </div>
  </div>
...
<!-- card start -->
<div class="container security  py-5">
  <div class="row  g-4">

    <div class="col-md-4">
      <div class="info-card">
        <div class="info-icon">
          <img src="public/assets/images/s1.png" alt="icon">
          
        </div>
        <div class="info-content">
          <p>Security Management</p>
          <p class="text-danger fw-bold">ISO/IEC 27001:2013</p>
          <p>Quality Management involves planning, controlling, and improving processes to ensure.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="info-card">
        <div class="info-icon">
          <img src="public/assets/images/s2.png" alt="icon">
          
        </div>
        <div class="info-content">
          <p>Quality Management</p>
          <p class="text-danger fw-bold">ISO 9001:2015</p>
          <p>Quality Management ensures that an organization consistently delivers products.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="info-card">
        <div class="info-icon">
          <img src="public/assets/images/s6.png" alt="icon">
          
        </div>
        <div class="info-content">
          <p>Happy Clients</p>
          <p class="text-danger fw-bold">5000+</p>
          <p>Our clients’ happiness reflects our commitment to quality, reliability,and personalized service.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="info-card">
        <div class="info-icon">
          <img src="public/assets/images/s4.png" alt="icon">
          
        </div>
        <div class="info-content">
          <p>Clients Retention</p>
          <p class="text-danger fw-bold">98%</p>
          <p>Client Retention focuses on maintaining long-term relationships.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="info-card">
        <div class="info-icon">
          <img src="public/assets/images/s5.png" alt="icon">
          
        </div>
        <div class="info-content">
          <p>Industry Experience</p>
          <p class="text-danger fw-bold">9+ Years</p>
          <p>Our extensive industry experience enables us to deliver tailored solutions.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="info-card">
        ...
        <div class="info-content">
          <p>Live Expert Free</p>
          <p class="text-danger fw-bold">24*7</p>
          <p>Get immediate answers and trusted guidance from industry professionals – absolutely free of cost.</p>
        </div>
      </div>
    </div>
...
<!-- review start -->
<div class="ratingbox mb-4 mx-lg-5  mx-2">
    <div class="review-section">
    <div class="review-header">
      <div class="left-panel ">
        <p>Clients Retention</p>
        <p>Based on 193 reviews</p>
        <div class="rating"><span class="num">5.0</span> <span class="star">★★★★★</span></div>
        <p>
          powered by
          <img class="google-logo" src="public/assets/images/Google_2015.png" alt="Google" />
        </p>
        <button class="review-button">
          Review us on
          <img src="public/assets/images/g-logo.png" alt="G" style="height: 30px;" />
        </button>
      </div>
      <div class="redbotter"></div>

      <div class="carousel-wrapper" aria-label="Client testimonials carousel">
        <div class="carousel-track" id="carouselTrack">
          <div class="card-group">
            <div class="card">
              <div class="profile">
                <img src=" public/assets/images/32.webp" alt="Mark Jones" />
                <div class="reinfo">
                  <strong>Mark Jones</strong><br />
                  <span>Founder & CEO</span>
                   <div class="stars">★★★★★</div>
                </div>
              </div>
             
               <p class="bestw">Best Work!</p>
              <p>I couldn’t be happier with my purchase. The quality is exceptional, and the support team was incredibly helpful.</p>
            </div>

            <div class="card">
              <div class="profile">
                <img src="public/assets/images/45.webp" alt="Sara Smith" />
                <div class="reinfo">
                  <strong>Sara Smith</strong><br />
                  <span>Marketing Head</span>
                  <div class="stars">★★★★★</div>
                </div>
              </div>
              
               <p class="bestw">Great Experience!</p>
              <p>The process was smooth and efficient. I really appreciate the attention to detail and customer care.</p>
            </div>

            <div class="card">
              <div class="profile">
                <img src="public/assets/images/52.webp" alt="John Doe" />
                <div class="reinfo">
               ...
               <p class="bestw">Highly Recommend</p>
              <p>The team exceeded my expectations. Professional, responsive, and reliable all the way through.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- section2 -->
   ...
   <div class="review-section">
    <div class="review-header">
      ...
      <div class="carousel-wrapper" aria-label="Client testimonials carousel">
        <div class="carousel-track2" id="carouselTrack">
          <div class="card-group2">
            <div class="card">
              <div class="profile">
                <img src="public/assets/images/t2.webp" alt="Mark Jones" />
                <div class="info">
                  <strong>Arun Kumar</strong><br />
                  <span>Founder & CEO</span>
                  <img style="height:22px;" src="public/assets/images/green-star.webp" alt="">
                </div>
              </div>
             
              <p class="bestw">Best Work!</p>
              <p>Trademark registration smooth & professional. Highly recommended.</p>
            </div>

            <div class="card">
              <div class="profile">
                <img src="public/assets/images/t3.webp" alt="Sara Smith" />
                <div class="info">
               ...
               <p class="bestw">Great Experience!</p>
              <p>Clear guidance, fast response, and stress-free process.</p>
            </div>

            <div class="card">
              <div class="profile">
                <img src="public/assets/images/t1.webp" alt="John Doe" />
                <div class="info">
               ...
               <p class="bestw">Highly Recommend</p>
              <p>Transparent pricing and regular updates. Great experience.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="left-panel">
        ...
        <div class="rating"><span class="green-star"><img src="public/assets/images/green-star.webp" width="55%" alt=""></span></div>
      
         <div class="trustimg"><img src="public/assets/images/truststart.png" alt="" width="50%"></div>
         <button class="review-button">
          Review us on
          <img src="public/assets/images/starsingle.png" alt="G" style="height: 30px;" />
        </button>
      </div>
        <div class="redbotter"></div>
...
<!-- review end -->
  ...
  <section class="re-gst la">
    <div class="container">
      <div class="row ">
        <!-- Left Large Card -->
        <div class="col-lg-6" id="leftCard">
         <div class="card-custom position-relative ">
            <h2>Trademark Registration</h2>(Business, Foreign Company, Individual)</h2>
            <p class="price fs-4">
              <span class="old-price"> <img src="public/assets/images/Dlogo.webp" alt="" style="width: 5%; ">10,000</span>
              <span> <img src="public/assets/images/Dlogo.webp" alt="" style="width: 5%; "> 7499</span> <span class="old-price">(All inclusive)</span>
            </p>
            <ul class="checklist" style="position: relative;z-index: 3000;">
              <li>deal for Individual, Proprietor</li>
            ...
            <img src="public/assets/images/landinggirl2.webp" alt="Thumbs up" class="thumbs-up-img" />
            <a onclick="openWhatsApp()"  href="#" class="btn btn-whatsapp">
              <img src="public/assets/images/icon1.webp" alt=""> WhatsApp Now
            </a>
          </div>  
        </div>
        ...
        <!-- Right Top Card -->
        <div class="col-lg-6" id="leftCard">
          <div class="card-custom d-none d-lg-block ">
            <h2> Trademark Registration Requirements</h4> (Business, Foreign Company, Individual) </h2>
              <ul class="checklist" style="position: relative;z-index: 3000;">
              ...
              <li>Power of Attorney(Notarized by notary public in UAE)</li>
               </ul>
            <a onclick="openWhatsApp()" href="#" class="btn btn-whatsapp">
              <img src="public/assets/images/icon1.webp" alt=""> WhatsApp Now
            </a>
          ...
          <div class="card-custom position-relative d-lg-none  ">
            <h4>Trademark Registration</h4><span class="dece">(Business, Foreign Company, Individual)</span>
          
            <ul class="checklist" style="position: relative;z-index: 3000;">
              <li>Trademark in PDF & Image file </li>
              <li>Trade License Copy</li>
              <li>Passport copy of Authorized Signatory</li>
               </ul>

            <img src="public/assets/images/landinggirl2.webp" alt="Thumbs up" class="thumbs-up-img-javascript" />
            <a 
onclick="openWhatsApp()" href="#" class="btn btn-whatsapp">
              <img src="public/assets/images/icon1.webp" alt=""> WhatsApp Now
            </a>
          </div>
        </div>
  ...
  <!-- advantage of trade mark start -->
    <div class="container mb-2">
        <div class="ssea">
    <p class="text-center fw-bold ">Advantages of</p>
    <h3 class="text-center fw-bold text-danger mb-3">Trademark Registration</h3>
    </div>
    <div class="row g-4">
      <!-- Card 1 -->
      <div class="col-md-6">
        <div class="advantage-box ">
          <div class="advantage-heading">Excellent Business Opportunity</div>
          <div class="d-flex">
            <p class="mt-2">
          ...
          <div class="advantage-number"><img src="public/assets/images/w-1.png" alt=""></div>
          </div>
        </div>
      </div>
      ...
      <!-- Card 2 -->
      <div class="col-md-6">
        <div class="advantage-box2 ">
          <div class="advantage-heading2">Legal Protection</div>
          <div class="d-flex">
           
          <div class="advantage-number2"><img src="public/assets/images/w-2.png" alt=""></div>
           <p class="mt-2">
      ...
      <div class="col-md-6">
        <div class="advantage-box ">
          <div class="advantage-heading">Get Unique Identity</div>
         <div class="d-flex">
           <p class="mt-2">
          ...
          <div class="advantage-number"><img src="public/assets/images/w-3.png" alt=""></div>
         </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="advantage-box2 ">
          <div class="advantage-heading2">Business Growth</div>
          <div class="d-flex">
             <div class="advantage-number2"><img src="public/assets/images/w-4.png" alt=""></div>
            <p class="mt-2">
          Business growth is the foundation of long-term success. It allows companies to expand their market presence, attract new customers, and strengthen existing relationships.
          </p>
  ...
  <section class="whose mt-4 mt-lg-0 dasasaSAda">
    <!-- help -->
    <div class="container  ">
      <!-- Heading -->
      <div class="section-title">
        <p class="small">We Help Our Clients to Secure <br> Their <span>Intellectual Property</span></p>
        <p>Partner with Bonamark to assess and register your trademarks in full <br>compliance with the local &
          international laws.</p>
      </div>

      <!-- Step Arrows -->
      <div class="d-flex justify-content-between px-5 m-done  align-items-center mb-4 flex-wrap text-center">
        <div class="mx-2 steps-arrow">Step 1</div>
        <div class="mx-2 steps-arrow"><img src="public/assets/images/arrow.webp" alt="" width="100px"></div>
        <div class="mx-2 steps-arrow">Step 2</div>
        <div class="mx-2 steps-arrow"><img src="public/assets/images/arrow.webp" alt="" width="100px"></div>
        <div class="mx-2 steps-arrow">Step 3</div>
        <div class="mx-2 steps-arrow"><img src="public/assets/images/arrow.webp" alt="" width="100px"></div>
        <div class="mx-2 steps-arrow">Step 4</div>
        <div class="mx-2 steps-arrow"><img src="public/assets/images/arrow.webp" alt="" width="100px"></div>
        <div class="mx-2 steps-arrow">Step 5</div>
         <div class="mx-2 steps-arrow"><img src="public/assets/images/arrow.webp" alt="" width="100px"></div>
      </div>

      <!-- Steps Grid -->
      <div class="d-lg-flex gridrow align-items-center justify-content-between p-3">
        <div>
          <div class="step-box ">
            <div class="step-icon"><img src="public/assets/images/search 1.webp" alt="" width="80px"></div>
            <div class="step-label">Trademark<br> Search</div>
          </div>
        </div>
        <div>
          <div class="step-boxbig">
            <div class="step-icon"><img src="public/assets/images/search 2.webp" alt="" width="80px"></div>
            <div class="step-label">Filing of a Trademark <br>Application</div>
          </div>
        </div>
        <div>
          <div class="step-box">
            <div class="step-icon"><img src="public/assets/images/search 3.webp" alt="" width="80px"></div>
            <div class="step-label">Application<br> Examination</div>
          </div>
        </div>
        <div>
          <div class="step-box">
            <div class="step-icon"><img src="public/assets/images/search 4.webp" alt="" width="80px"></div>
            <div class="step-label">Gazette <br>Publication</div>
          </div>
        </div>
        <div>
          <div class="step-box">
            <div class="step-icon"><img src="public/assets/images/search 5.webp" alt="" width="80px"></div>
            <div class="step-label">Registration <br> Certificate</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class=" call-to py-5">
    <div class="container">
      <div class="text-center jde bg-white p-5 rounded-5 shadow-sm">
        <h3 class="fw-bold mb-3">Talk to our Experts & Get Trademark Registration</h3>
        <p class="fw-semibold mb-4  allinclusive">
          <b>  <span class="text-dark"><img src="public/assets/images/Dlogo.webp" alt="" style="width: 5%; ">7499</b></span>
